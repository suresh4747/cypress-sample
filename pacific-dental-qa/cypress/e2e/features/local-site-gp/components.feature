@LocalGP
Feature: Validate the LO-GP Components
  ...
  Scenario: Opening the search overlay from the homepage
    ...
    And the border bottom of search overloy should have "00bfe0" color
  ...
  Scenario: Performing a search from the overlay
    ...
    Then the user should navigate to a page where the URL contains "#q=searched%20text"
  ...
  Scenario: Verify Highlighting colour of Selected Photos in gallery for GP site
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-1/gallery-component/gallery-component-images-and-videos/"
    And I click on a photo in the below strip
    Then the clicked photo should be highlighted in "#FFEE84" for GP site
    And the corresponding bigger image should have background color black
    And color of arrow icon should be "#2D5F66" for GP site

  # SWATCH COLOR COMPONENT
  Scenario: Verify swatch colours for GP site
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-1/swatch-color-/container/?dddsl"
    And check the first color code should be "#86B6E6" for GP site
    And check the second color code should be "#FFEE84" for GP site
    And check the third color code should be "#F7F8FC" for GP site
    And check the fourth color code should be "#F0FAFC" for GP site
  ...
  Scenario: Verify Primary Button
    ...
    Then the primary button background color should be "#FFEE84"
    And the primary button font size should be "16px"
    And the primary button font colour should be "#444444"
  ...
  Scenario: Verify link CTA
    ...
    And underline colour should be "#00BFE0"
  ...
  Scenario: Verify category Tag CTA
    ...
    And the category Tag font colour should be "#2d5f66"

  Scenario: Verify secondary CTA
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-1/button/button-test/"
    Then the secondary CTA background color should be "rgba(0, 0, 0, 0)"
    And the secondary CTA font size should be "16px"
    And the secondary CTA font colour should be "#444444"
    And the secondary CTA outline colour should be "#00bfe0"
  ...
  Scenario: Verify underline white on state
    ...
    And underline white on state underline colour should be "#00bfe0"
  ...
  Scenario: Verify Secondary White CTA
    ...
    And the secondary white CTA font colour should be "#2d5f66"

  # #RTE Redesign
  Scenario: Verify RTE GP Styling
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-1/text/"
    Then I should see the font colour options "#2D5F66", "#FFFFFF", "#FFEE84", "#444444" for GP
    And I should see the body text font size and font type for GP as "18px" and "Poppins, sans-serif"
    And I should see the link text colour for GP as "#0097a8" and size as "18px"
    And I should see the font type for H1 in GP as "h1" and size as "104px"
    And I should see the font type for H2 in GP as "h2" and size as "80px"
    And I should see the font type for H3 in GP as "h3" and size as "62px"
    And I should see the font type for H4 in GP as "h4" and size as "48px"
    And I should see the font type for H5 in GP as "h5" and size as "34px"
    And I should see the font type for H6 in GP as "h6" and size as "22px"
    And I should see the font type for Style 1 in GP as "title-1" and size as "104px"
    And I should see the font type for Style 2 in GP as "title-2" and size as "80px"
    And I should see the font type for Style 3 in GP as "title-3" and size as "62px"
    And I should see the font type for Style 4 in GP as "title-4" and size as "48px"
    And I should see the font type for Style 5 in GP as "title-5" and size as "34px"
    And I should see the font type for Style 6 in GP as "title-6" and size as "22px"
    And I should see the font type for Style 7 in GP as "title-7" and size as "16px"
    And I should see the font type for Style 8 in GP as "title-8" and size as "12px"

  #TITLE Redesign
  Scenario: Verify title for GP
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-2/title/h1/"
    Then I should see the title heading colour option as "#2D5F66", "#444444", "#FFFFFF", "#FFEE84" for GP title
    And I should see the title heading type for H1 in GP as "h1" and heading size as "104px"
    And I should see the title heading type for "h1" Style 1 in GP as "style-1" and heading size as "104px"
    And I should see the title heading type for "h1" Style 2 in GP as "style-2" and heading size as "80px"
    And I should see the title heading type for "h1" Style 3 in GP as "style-3" and heading size as "62px"
    And I should see the title heading type for "h1" Style 4 in GP as "style-4" and heading size as "48px"
    And I should see the title heading type for "h1" Style 5 in GP as "style-5" and heading size as "34px"
    And I should see the title heading type for "h1" Style 6 in GP as "style-6" and heading size as "22px"
    And I should see the title heading type for "h1" Style 7 in GP as "style-7" and heading size as "16px"
    And I should see the title heading type for "h1" Style 8 in GP as "style-8" and heading size as "12px"
    When I navigate to the "safe-house/other-testing/sprint-2/title/h2/"
    And I should see the title heading type for H2 in GP as "h2" and heading size as "80px"
    And I should see the title heading type for "h2" Style 1 in GP as "style-1" and heading size as "104px"
    And I should see the title heading type for "h2" Style 2 in GP as "style-2" and heading size as "80px"
    And I should see the title heading type for "h2" Style 3 in GP as "style-3" and heading size as "62px"
    And I should see the title heading type for "h2" Style 4 in GP as "style-4" and heading size as "48px"
    And I should see the title heading type for "h2" Style 5 in GP as "style-5" and heading size as "34px"
    And I should see the title heading type for "h2" Style 6 in GP as "style-6" and heading size as "22px"
    And I should see the title heading type for "h2" Style 7 in GP as "style-7" and heading size as "16px"
    And I should see the title heading type for "h2" Style 8 in GP as "style-8" and heading size as "12px"
    When I navigate to the "safe-house/other-testing/sprint-2/title/h3/"
    And I should see the title heading type for H3 in GP as "h3" and heading size as "62px"
    And I should see the title heading type for "h3" Style 1 in GP as "style-1" and heading size as "104px"
    And I should see the title heading type for "h3" Style 2 in GP as "style-2" and heading size as "80px"
    And I should see the title heading type for "h3" Style 3 in GP as "style-3" and heading size as "62px"
    And I should see the title heading type for "h3" Style 4 in GP as "style-4" and heading size as "48px"
    And I should see the title heading type for "h3" Style 5 in GP as "style-5" and heading size as "34px"
    And I should see the title heading type for "h3" Style 6 in GP as "style-6" and heading size as "22px"
    And I should see the title heading type for "h3" Style 7 in GP as "style-7" and heading size as "16px"
    And I should see the title heading type for "h3" Style 8 in GP as "style-8" and heading size as "12px"
    When I navigate to the "safe-house/other-testing/sprint-2/title/h4/"
    And I should see the title heading type for H4 in GP as "h4" and heading size as "48px"
    And I should see the title heading type for "h4" Style 1 in GP as "style-1" and heading size as "104px"
    And I should see the title heading type for "h4" Style 2 in GP as "style-2" and heading size as "80px"
    And I should see the title heading type for "h4" Style 3 in GP as "style-3" and heading size as "62px"
    And I should see the title heading type for "h4" Style 4 in GP as "style-4" and heading size as "48px"
    And I should see the title heading type for "h4" Style 5 in GP as "style-5" and heading size as "34px"
    And I should see the title heading type for "h4" Style 6 in GP as "style-6" and heading size as "22px"
    And I should see the title heading type for "h4" Style 7 in GP as "style-7" and heading size as "16px"
    And I should see the title heading type for "h4" Style 8 in GP as "style-8" and heading size as "12px"
    When I navigate to the "safe-house/other-testing/sprint-2/title/h5/"
    And I should see the title heading type for H5 in GP as "h5" and heading size as "34px"
    And I should see the title heading type for "h5" Style 1 in GP as "style-1" and heading size as "104px"
    And I should see the title heading type for "h5" Style 2 in GP as "style-2" and heading size as "80px"
    And I should see the title heading type for "h5" Style 3 in GP as "style-3" and heading size as "62px"
    And I should see the title heading type for "h5" Style 4 in GP as "style-4" and heading size as "48px"
    And I should see the title heading type for "h5" Style 5 in GP as "style-5" and heading size as "34px"
    And I should see the title heading type for "h5" Style 6 in GP as "style-6" and heading size as "22px"
    And I should see the title heading type for "h5" Style 7 in GP as "style-7" and heading size as "16px"
    And I should see the title heading type for "h5" Style 8 in GP as "style-8" and heading size as "12px"
    When I navigate to the "safe-house/other-testing/sprint-2/title/h6/"
    And I should see the title heading type for H6 in GP as "h6" and heading size as "22px"
    And I should see the title heading type for "h6" Style 1 in GP as "style-1" and heading size as "104px"
    And I should see the title heading type for "h6" Style 2 in GP as "style-2" and heading size as "80px"
    And I should see the title heading type for "h6" Style 3 in GP as "style-3" and heading size as "62px"
    And I should see the title heading type for "h6" Style 4 in GP as "style-4" and heading size as "48px"
    And I should see the title heading type for "h6" Style 5 in GP as "style-5" and heading size as "34px"
    And I should see the title heading type for "h6" Style 6 in GP as "style-6" and heading size as "22px"
    And I should see the title heading type for "h6" Style 7 in GP as "style-7" and heading size as "16px"
    And I should see the title heading type for "h6" Style 8 in GP as "style-8" and heading size as "12px"
  ...
  Scenario: Verify Single Quote
    ...
    And the background color of quote should be "#0097a8"
  ...
  Scenario: Verify Three Quotes Carousel
    ...
    And the background color of quote should be "#0097a8" for first quote
    ...
    And the background color of quote should be "#0097a8" for second quote
    ...
    And the background color of quote should be "#0097a8" for third quote
  ...
  Scenario: Verify Magazine Carousel carousel Redesign
    ...
    And magazine carousel arrow colour should be "#2d5f66"
    And the magazine carousel title colour should be "#0097A8"

  Scenario: Verify Magazine Carousel 4 column Redesign
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-2/magazine-and-common/"
    Then I should be able to see 4 Magazine carousel component
    And the 4 magazine carousel title colour should be "#0097A8"

  Scenario: Verify Magazine Carousel 2 column Redesign
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-2/magazine-and-common/"
    Then I should be able to see 2 Magazine carousel component
    And the 2 magazine carousel title colour should be "#0097A8"
  ...
  Scenario: Verify Text Card with CTA
    ...
    And verify the CTA has underline color "#00BFE0"
  ...
  Scenario: Verify Fact Card
    ...
    Then the fact card should have a "#86B6E6", "#F0FAFC", "#F7F8FC", "#FFEE84" background
  ...
  Scenario: Verify cost estimator cost colour for GP
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-2/cost-estimator/"
    Then the cost estimator cost colour should be "#2d5f66"
    And the cost estimator arrow colour should be "#2d5f66"
    And the cost estimator tab border top colour should be "#2d5f66"

  # TEASER
  Scenario: Verify when user clicks "See More" link to view more description
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-4/teaser/teaser1/?fas"
    ...
    And verify the "see more" link has underline with color "#00bfe0"
    ...
    And verify "see less" link has underline with color "#00bfe0"
  ...
  Scenario: Verify image is present at left position and teaser with CTA
    ...
    And verify the CTA link has underline with color "#00bfe0"
  ...
  Scenario: Verify image is present at right position and teaser with CTA
    ...
    And verify CTA link has underline with color "#00bfe0"
  ...
  Scenario: Verify 3 cards listing
    ...
    And title should be in "#0097a8" color
  ...
  Scenario: Verify 4 cards listing
    ...
    And title should be in "#0097a8" color on 4 cards listing
  ...
  Scenario: Verify carousel listing
    ...
    And "more" text should be in "#0097a8" color
    And arrow icon with more text color should be "#0097a8"
    ...
    And "less" text should be in this "#0097a8" color
    And arrow icon with less text color should be "#0097a8"
  ...
  Scenario: Verify Carousel with Fact Card Display and Navigation
    ...
    And the card title is having font family "Poppins, sans-serif" and font size "36px" on fact card component
  ...
  Scenario: Verify eBook download functionality
    ...
    And background color of popup should be "#0097A8"
  ...
  Scenario: Verify Promoblock Component Styling
    ...
    And the primary button with "#ffee84" background color and secondary with "#00bfe0" border color should be visible
  ...
  Scenario: View Overview Information
    ...
    And I should see the following insurance information:
      ...
      | United Health Care |
      | UCCI               |
    And I should see phone number "404-329-0411" and fax number "fax : 404-418-7016"
    And color of phone number "404-329-0411" and fax number "fax : 404-418-7016" should be "#0097a8"
    ...
    And I should see address "144 Moreland Ave""NE Ste A""Atlanta, GA""30307"
    And color of address "144 Moreland Ave""NE Ste A""Atlanta, GA""30307" should be "#0097a8"
    ...
    Then verify that Book Appointment CTA button has "https://www.EdgewoodSmilesDentistry.com/contact/appt-only" in URL, response status is 200
    ...
    And there should be text below button as "We are located on the corner of Moreland Ave and Brantley Street next to Salon Lofts and across from the Target shopping center"
  ...
  Scenario: Navigate to Staff Profile by Clicking on Staff Listing Card
    Given I am on the LO_GP homepage
    When I navigate to the "safe-house/other-testing/sprint-4/office-info/"
    Then the URL should contain the staff name
...
Scenario: Verify Tab Underline Color for GP
  Given I am on the LO_GP homepage
  When I navigate to the "safe-house/other-testing/sprint-4/faq/"
  Then I should see the tab is underlined with color "#00bfe0"
...
Scenario: Verify Dental Services
    ...
    And the link should be underlined in "#00bfe0"
...
Scenario: Verify the alert bar, address bar, and header
  ...
  And there is a background colour present for the alert bar "00bfe0"
  And clicking on the close icon in the alert bar closes the alert bar
  And address bar text contains "Moreland"
...
Scenario Outline: Verify the header elements and navigation functionality
  ...
  And the "SCHEDULE" button contains "/about-us/dentist-appointment/" in the URL
  ...
  Examples:
    ...
    | INSURANCE & PAYMENTS | payment         |
    | ABOUT US             | about-us        |

# STAFF INTRO
Scenario: Verify the staff intro component and its elements
  Given I am on the LO_GP homepage
  When I navigate to the "safe-house/other-testing/sprint-4/staff-intro/?ic=ewwdre?jk"
  ...
  Scenario: Check Colour of Footer Column Headings
    ...
    And all footer column headings should have color "#0097a8"
...
Scenario: Verify Copyright text
  ...
  And verify that font type is "Poppins, sans-serif" and font size is "12px"