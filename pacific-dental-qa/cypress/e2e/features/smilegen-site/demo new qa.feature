...
Feature: Validate the smilegen Website Components
    ...
    #     When I navigate to the "/othertesting/primary-nav-variations/landing-page-variation.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/primary-nav-variations/home-page-variation.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I scroll down the page ".html" a little then header should become sticky
    ...
    #     Given I am on the smilegen homepage
    #     When I scroll down the page ".html" and then scroll back up
    #     Then The header should return to its normal state

    # Scenario: Verify the header nav bar on Dark Text variation
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/primary-nav-variations/dark-text-variation.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/primary-nav-variations/solid-background-variation.html"
    #     Then verify the header nav items colour is black
    #     And verify header is in Poppins font with size
    #     Then That button is primary category
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/hero-variations/landing-page-variation.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/hero-variations/text-only-variation.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/hero-variations/text-only-with-copy.html"
    #     And I verify the title UI
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/hero-variations/bg-image-variation.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/hero-variations/category-page.html"
    #     Then there should be a background image on the page
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/hero-variations/landing-page-white-text-top-copy.html"
    #     Then there should be a background image on the page
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/text.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/button1.html"
    ...
    #     And the body text font family should be "RobotoSerif, sans-serif"
    #     And the subscribe text font family should be "Poppins, sans-serif"

    # # card component
    # Scenario: Verify Text Card with CTA
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/text-card/text-card-with-cta.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/text-card/text-card-without-cta.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/fact-card/yellow-fact-card.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/yellow-card-cta/cost-card.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/yellow-card-cta/with-tags.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/generations-of-smiles.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/teaser/teaser2.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/staggered-card-update/title.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/staggered-card-update/with-cta.html"
    #     And the title should be present in the staggered card component
    #     And the description should be present in the staggered card component
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/staggered-card-update/review.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/quote.html"
    ...
    #     And the quote author text should be in "RobotoSerif, sans-serif" and font size should be "18px"

    # Scenario: Verify Three Quotes Carousel
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/3-quotes.html"
    #     Then the quote component is loaded on the page
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/cost-estimator.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/payment-options/smile-generation-dental-plan.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/gallery-component-.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/sprint-7-demo/blog-listing/blog-listing-1.html"
    ...
    #     When I navigate to the "/sprint-7-demo/blog-page-.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/ebook.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/curated-listing.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/dynamic-listing-/blog-list-variation.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/dynamic-listing-/blog-carousel-variation.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/common-concerns1.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/mouth-body-connection/magazine.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/87507/566.html"
    ...
    #     And the description is having font family "RobotoSerif, sans-serif" and font size "20px" on Office Appointment Scheduler
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/provider-staff/Hygienist-Ignasio-Alonso-38192.html"
    ...
    #     And the subtitle is having font family "Poppins, sans-serif" and font size "70px" on Provider Appointment Scheduler
    #     And the description is displayed on Provider Appointment Scheduler
    #     And the description is having font family "RobotoSerif, sans-serif" and font size "20px" on Provider Appointment Scheduler
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/95376/252.html"
    ...
    #     And "BOOK AN APPOINTMENT" button is present
    #     And the "BOOK AN APPOINTMENT" CTA is having font family "Poppins, sans-serif" and font size "14px" on Office profile component
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/faqs.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/37922/858.html"
    #     Then I should see the following business hours and the font-family should be "RobotoSerif, sans-serif":
    #         | Business hours                |
    #         | Mon : 8:00 AM - 5:00 PM       |
    #         | Tue : 8:00 AM - 5:00 PM       |
    #         | Wed : 8:00 AM - 5:00 PM       |
    ...
    #     And I should see the following insurance information and the font-family should be "Poppins, sans-serif":
    #         | Insurance company  |
    #         | Aetna              |
    #         | Ameritas           |
    #         | Anthem Blue Cross  |
    ...
    #     And the "BOOK AN APPOINTMENT" CTA is having font family "Poppins, sans-serif" and font size "14px" on office profile overview and info component
    #     Then verify that GET DIRECTIONS CTA button has "https://www.NorthshoreSmilesDentistry.com/contact/appt-only" in URL, response status is 200
    ...
    #     And doctor's name should go to the corresponding link "/provider-staff.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/provider-staff/dentist-madison-dolen-39878"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/sprint-7-demo/blog-listing/blog-listing-1l"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/mychart-portal.html"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/map.html"
    ...
    #         | United Health Care |
    #         | UCCI               |
    #     And the insurance list item is having the font family "Poppins, sans-serif" and font size "20px"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "/othertesting/map-and-file-.html"
    ...
    #     Then Verify the status code should be the 200 for each link in MOUTH BODY CONNECTION Column
    ...
    #     Then Verify the status code should be the 200 for each link in DENTAL SERVICES Column
    ...
    #     Then Verify the status code should be the 200 for each link in PAYMENT OPTIONS Column
    ...
    #     Then Verify the status code should be the 200 for each link in HOW WE GIVE Column
    ...
    #     Then Verify the status code should be the 200 for each link in ABOUT Column
...
# Scenario: Verify the "Mouth-Body Connection" Tab on Dark Text variation
#     Given I am on the smilegen homepage
#     When I navigate to the "/othertesting/primary-nav-variations/dark-text-variation"
#     And I click on the "Mouth-Body Connection" navigation to see all the links and flyer is open
#     Then I should see two columns inside the flyer: "CATEGORIES" and "RESOURCES"
...
# #     Given I am on the smilegen homepage
# #     When I navigate to the "/othertesting/homepage"
# #     And I scroll to the footer section
# #     Then I should see the "DENTAL SERVICES" in column two in the footer
