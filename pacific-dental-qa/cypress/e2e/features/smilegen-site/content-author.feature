...
Feature: Validate the smilegen Website Components
    ...
    #     When I navigate to the "conversion-landing-page/?htyu"
    ...
    #     Given I am on the smilegen homepage
    #     When I scroll down the page "" a little then header should become sticky
    ...
    #     Given I am on the smilegen homepage
    #     When I scroll down the page "" and then scroll back up
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "blog/ask-a-dentist/dental-phobia-and-dental-anxiety-explained/"
    #     Then verify the header nav items colour is black
    #     And verify header is in Poppins font with size
    #     Then That button is primary category
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "conversion-landing-page/"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "dental-services/crooked-teeth/"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "dental-services/general-dentistry/routine-cleaning/"
    #     And I verify the title UI
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "dental-services/"
    #     Then there should be a background image on the page
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "mouth-body-connection/heart-health/"
    #     Then there should be a background image on the page
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "covid-19/"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "payment-options/smile-generation-dental-plan/"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "dental-services/general-dentistry/routine-cleaning/?sss"
    #     Then verify the teaser with an image on the page
    #     And verify the teaser has a heading and subtext
    #     And the title should be in "Poppins, sans-serif" and font size should be "70px"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "dental-services/general-dentistry/"
    ...
    #     And title should be in the "Poppins, sans-serif" and font size should be "70px"
    ...
    #     And the title should be present in the staggered card component
    #     And the description should be present in the staggered card component
    #     And Card description should be "RobotoSerif, sans-serif" and font size should be "16px"
    #     And staggered card component title is "Poppins, sans-serif" and font size should be "100px"
    #     And staggered card component description is "Roboto, sans-serif" and font size should be "18px"
    #     And the CTA link should be present in the staggered card component
    #     And CTA text in the staggered card component should be in "Poppins, sans-serif" and the font size should be "18px"
    ...
    #     # # review star and author name are missing
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "how-we-give/special-olympics/"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "dental-services/smile-generation-mychart/"
    #     Then the quote component is loaded on the page
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "payment-options/smile-generation-dental-plan/"
    #     When user clicks on "Crown" tab
    #     Then the content of "Crown" should be displayed
    ...
    #     When I navigate to the "blog/ask-a-dentist/dental-financing-terms/"
    ...
    #     And "EXPLORE OUR BLOG" button should be displayed on right side
    #     And the Button text "EXPLORE OUR BLOG" is having font family "Poppins, sans-serif" and font size "18px" on 3 cards listing
    ...
    #     And I see that the "EXPLORE OUR BLOG" button should have 200 status code on 3 cards listing
    ...
    #     And "READ MORE" button should be displayed on right side of carousel listing component
    #     And the Button text "READ MORE" is having font family "Poppins, sans-serif" and font size "18px" on 4 carousel listing
    #     And I see that there are 3 cards in the listing
    #     And Each card has image title and description
    ...
    #     And I see that the "READ MORE" button should have 200 status code on 3 carousel listing
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "othertesting/common-concerns1/"
    ...
    #     Given I am on the smilegen homepage
    #     When I navigate to the "mouth-body-connection/magazine/"
    ...
    Scenario: Verify Blog Listing Page
        Given I am on the smilegen homepage
        When I navigate to the "blog/ask-a-dentist/"
