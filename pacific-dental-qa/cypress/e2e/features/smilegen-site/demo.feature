...
Feature: Validate the smilegen Website Components
    ...
    Scenario: Verify Successful Newsletter Subscription on Overview Page
        ...
        And the confirmation message color should be black "rgb(68, 68, 68)"
    ...
    Scenario: Verify when user clicks "See More" link to view more description
        Given I am on the smilegen homepage
        When I navigate to the "othertesting/generations-of-smiles/?asakk"
    ...
    Scenario: Verify Single Quote
        Given I am on the smilegen homepage
        When I navigate to the "othertesting/quote/?dss"
    ...
    Scenario: Verify Three Quotes Carousel
        Given I am on the smilegen homepage
        When I navigate to the "othertesting/3-quotes/?098"
        Then the quote component is loaded on the page
    ...
    Scenario: Verify display of icons based on number of tabs in cost estimator
        Given I am on the smilegen homepage
        When I navigate to the "payment-options/dental-discount-plan/?asd"
    ...
    Scenario: Verify Carousel with Fact Card Display and Navigation
        Given I am on the smilegen homepage
        When I navigate to the "othertesting/dynamic-listing-/blog-carousel-variation/?kl0n"
    ...
    Scenario: Displaying Office Appointment Scheduler
        Given I am on the smilegen homepage
        When I navigate to the "provider-staff/dentist-buki-ajayi-21361/?kl"
    ...
    Scenario: Verfiy Office profile
        ...
        Then verify that BOOK APPOINTMENT button has "https://www.RiversideGatewayDental.com/contact/appt-only" in URL, response status is 200
        ...
        Then verify that the Website CTA button has "https://www.RiversideGatewayDental.com" in URL, response status is 200
        ...
        Then verify that Find us on Google CTA button has "https://maps.google.com/maps?cid=8475376874909942165" in URL, response status is 200
...
#     # # PROVIDER PROFILE
    Scenario: Verfiy Provider profile
        ...
        And The Hero title should contain "Buki Ajayi, DMD" on Provider profile component
        And the Hero title is having font family "Poppins, sans-serif" and font size "70px" on Provider profile component
        And Hero sub title should contain "Dentist" on Provider profile component
    ...
    Scenario: Verify FAQ page elements
        Given I am on the smilegen homepage
        When I navigate to the "faqs/?ic=qdfq"
    ...
    Scenario: Verify Dental Services
        Given I am on the smilegen homepage
        When I navigate to the "/92503/17-abc/?ic=-sjwq"
...
Scenario: Verify presence of 1-800-smilegen link in the footer
    ...
    And the link should have a valid href attribute "tel:1-800-12345"
