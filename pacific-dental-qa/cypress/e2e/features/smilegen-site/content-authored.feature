...
# #         # Update CSS and 621 x 0 pixels image
...
#     #     And the title should be present in the staggered card component
#     #     And the description should be present in the staggered card component
#     #     # Getting Poppins in DOM and Update CSS
...
#     #     # # Image is missing
#     #     # And the background image should be present
#     #     # # Getting 404 for Find a Dentist button
#     #     And verify CTA response is 200
...
#     #     # # There are not left and right arrows 
...
#     #     # Getting failed on this step because I get it for 2 times only - JATIN
...
#     #     Given I am on the smilegen homepage
#     #     When I navigate to the "37922/858/"
