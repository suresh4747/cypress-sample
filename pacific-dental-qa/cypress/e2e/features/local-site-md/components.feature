@LocalMD
Feature: Validate the LO_MD Website Components
  ...
  Scenario: Opening the search overlay from the homepage
    ...
    And the border bottom of search overloy should have "#0097a8" color
  ...
  Scenario: Verify Highlighting colour of Selected Photos in gallery for MD site
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-1/gallery-component/gallery-component-images-and-videos/"
    And I click on a photo in the below strip
    Then the clicked photo should be highlighted in "#0097A8" for MD site
    And the corresponding bigger image should have background color black
    And color of arrow icon should be "#0097A8" for MD site

  # SWATCH COLOR COMPONENT
  Scenario: Verify swatch colours for MD site
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-1/swatch-color-/container/"
    And check the first color code should be "#D6EDE8" for MD site
    And check the second color code should be "#ACD08C" for MD site
    And check the third color code should be "#07BCDA" for MD site
    And check the fourth color code should be "#F7F8FC" for MD site

  # BUTTON COMPONENT
  Scenario: Verify Primary Button
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-1/button/button-test/"
    Then the primary button background color should be "#FFCD47" for MD site
    And the primary button font size should be "16px" for MD site
    And the primary button font colour should be "#444444" for MD site

  Scenario: Verify link CTA
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-1/button/button-test/"
    Then the link CTA font size should be "18px" for MD site
    And the link CTA font colour should be "#444444" for MD site
    And underline colour should be "#0097A8" for MD site

  Scenario: Verify category Tag CTA
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-1/button/button-test/"
    Then the category Tag background color should be "#F7F8FC" for MD site
    And the category Tag font size should be "14px" for MD site
    And the category Tag font colour should be "#0097A8" for MD site

  Scenario: Verify secondary CTA
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-1/button/button-test/"
    Then the secondary CTA background color should be "rgba(0, 0, 0, 0)" for MD site
    And the secondary CTA font size should be "16px" for MD site
    And the secondary CTA font colour should be "#444444" for MD site
    And the secondary CTA outline colour should be "#0097A8" for MD site

  Scenario: Verify underline white on state
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-1/button/button-test/"
    And the underline white on state font size should be "18px" for MD site
    And the underline white on state font colour should be "#FFFFFF" for MD site
    And underline white on state underline colour should be "#0097A8" for MD site

  Scenario: Verify Secondary White CTA
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-1/button/button-test/"
    Then the secondary white CTA background color should be "#FFFFFF" for MD site
    And the secondary white CTA font size should be "16px" for MD site
    And the secondary white CTA font colour should be "#0097A8" for MD site

  # RTE design
  Scenario: Verify RTE MD Styling
    Given I am on the LO_MD homepage
    When I navigate to the "/safe-house/other-testing/sprint-1/text/"
    Then I should see the font colour options "#0097A8", "#FFFFFF", "#FFCD47", "#444444" for MD
    And I should see the body text font size and font type for MD as "18px" and "Poppins, sans-serif"
    And I should see the link text colour for MD as "#0097a8" and size as "18px"
    And I should see the font type for H1 in MD as "h1" and size as "104px"
    And I should see the font type for H2 in MD as "h2" and size as "80px"
    And I should see the font type for H3 in MD as "h3" and size as "62px"
    And I should see the font type for H4 in MD as "h4" and size as "48px"
    And I should see the font type for H5 in MD as "h5" and size as "34px"
    And I should see the font type for H6 in MD as "h6" and size as "22px"
    And I should see the font type for Style 1 in MD as "title-1" and size as "104px"
    And I should see the font type for Style 2 in MD as "title-2" and size as "80px"
    And I should see the font type for Style 3 in MD as "title-3" and size as "62px"
    And I should see the font type for Style 4 in MD as "title-4" and size as "48px"
    And I should see the font type for Style 5 in MD as "title-5" and size as "34px"
    And I should see the font type for Style 6 in MD as "title-6" and size as "22px"
    And I should see the font type for Style 7 in MD as "title-7" and size as "16px"
    And I should see the font type for Style 8 in MD as "title-8" and size as "12px"

  # Title
  Scenario: Verify title for MD
    Given I am on the LO_MD homepage
    When I navigate to the "/safe-house/other-testing/sprint-2/title/h1/?cs"
    Then I should see the title heading colour option as "#0097A8", "#444444", "#FFFFFF", "#FFCD47" for MD title
    And I should see the title heading type for H1 in MD as "h1" and heading size as "104px"
    And I should see the title heading type for "h1" Style 1 in MD as "style-1" and heading size as "104px"
    And I should see the title heading type for "h1" Style 2 in MD as "style-2" and heading size as "80px"
    And I should see the title heading type for "h1" Style 3 in MD as "style-3" and heading size as "62px"
    And I should see the title heading type for "h1" Style 4 in MD as "style-4" and heading size as "48px"
    And I should see the title heading type for "h1" Style 5 in MD as "style-5" and heading size as "34px"
    And I should see the title heading type for "h1" Style 6 in MD as "style-6" and heading size as "22px"
    And I should see the title heading type for "h1" Style 7 in MD as "style-7" and heading size as "16px"
    And I should see the title heading type for "h1" Style 8 in MD as "style-8" and heading size as "12px"
    When I navigate to the "/safe-house/other-testing/sprint-2/title/h2/"
    And I should see the title heading type for H2 in MD as "h2" and heading size as "80px"
    And I should see the title heading type for "h2" Style 1 in MD as "style-1" and heading size as "104px"
    And I should see the title heading type for "h2" Style 2 in MD as "style-2" and heading size as "80px"
    And I should see the title heading type for "h2" Style 3 in MD as "style-3" and heading size as "62px"
    And I should see the title heading type for "h2" Style 4 in MD as "style-4" and heading size as "48px"
    And I should see the title heading type for "h2" Style 5 in MD as "style-5" and heading size as "34px"
    And I should see the title heading type for "h2" Style 6 in MD as "style-6" and heading size as "22px"
    And I should see the title heading type for "h2" Style 7 in MD as "style-7" and heading size as "16px"
    And I should see the title heading type for "h2" Style 8 in MD as "style-8" and heading size as "12px"
    When I navigate to the "/safe-house/other-testing/sprint-2/title/h3/"
    And I should see the title heading type for H3 in MD as "h3" and heading size as "62px"
    And I should see the title heading type for "h3" Style 1 in MD as "style-1" and heading size as "104px"
    And I should see the title heading type for "h3" Style 2 in MD as "style-2" and heading size as "80px"
    And I should see the title heading type for "h3" Style 3 in MD as "style-3" and heading size as "62px"
    And I should see the title heading type for "h3" Style 4 in MD as "style-4" and heading size as "48px"
    And I should see the title heading type for "h3" Style 5 in MD as "style-5" and heading size as "34px"
    And I should see the title heading type for "h3" Style 6 in MD as "style-6" and heading size as "22px"
    And I should see the title heading type for "h3" Style 7 in MD as "style-7" and heading size as "16px"
    And I should see the title heading type for "h3" Style 8 in MD as "style-8" and heading size as "12px"
    When I navigate to the "/safe-house/other-testing/sprint-2/title/h4/"
    And I should see the title heading type for H4 in MD as "h4" and heading size as "48px"
    And I should see the title heading type for "h4" Style 1 in MD as "style-1" and heading size as "104px"
    And I should see the title heading type for "h4" Style 2 in MD as "style-2" and heading size as "80px"
    And I should see the title heading type for "h4" Style 3 in MD as "style-3" and heading size as "62px"
    And I should see the title heading type for "h4" Style 4 in MD as "style-4" and heading size as "48px"
    And I should see the title heading type for "h4" Style 5 in MD as "style-5" and heading size as "34px"
    And I should see the title heading type for "h4" Style 6 in MD as "style-6" and heading size as "22px"
    And I should see the title heading type for "h4" Style 7 in MD as "style-7" and heading size as "16px"
    And I should see the title heading type for "h4" Style 8 in MD as "style-8" and heading size as "12px"
    When I navigate to the "/safe-house/other-testing/sprint-2/title/h5/"
    And I should see the title heading type for H5 in MD as "h5" and heading size as "34px"
    And I should see the title heading type for "h5" Style 1 in MD as "style-1" and heading size as "104px"
    And I should see the title heading type for "h5" Style 2 in MD as "style-2" and heading size as "80px"
    And I should see the title heading type for "h5" Style 3 in MD as "style-3" and heading size as "62px"
    And I should see the title heading type for "h5" Style 4 in MD as "style-4" and heading size as "48px"
    And I should see the title heading type for "h5" Style 5 in MD as "style-5" and heading size as "34px"
    And I should see the title heading type for "h5" Style 6 in MD as "style-6" and heading size as "22px"
    And I should see the title heading type for "h5" Style 7 in MD as "style-7" and heading size as "16px"
    And I should see the title heading type for "h5" Style 8 in MD as "style-8" and heading size as "12px"
    When I navigate to the "/safe-house/other-testing/sprint-2/title/h6/"
    And I should see the title heading type for H6 in MD as "h6" and heading size as "22px"
    And I should see the title heading type for "h6" Style 1 in MD as "style-1" and heading size as "104px"
    And I should see the title heading type for "h6" Style 2 in MD as "style-2" and heading size as "80px"
    And I should see the title heading type for "h6" Style 3 in MD as "style-3" and heading size as "62px"
    And I should see the title heading type for "h6" Style 4 in MD as "style-4" and heading size as "48px"
    And I should see the title heading type for "h6" Style 5 in MD as "style-5" and heading size as "34px"
    And I should see the title heading type for "h6" Style 6 in MD as "style-6" and heading size as "22px"
    And I should see the title heading type for "h6" Style 7 in MD as "style-7" and heading size as "16px"
    And I should see the title heading type for "h6" Style 8 in MD as "style-8" and heading size as "12px"
  ...
  Scenario: Verify the presence and properties of the information component
    ...
    And the "MuhammadAhmad" text should be "Poppins, sans-serif" and font size is "20px"
    ...
    And the background color of button should be "#0097a8"
  ...
  Scenario: Verify Common Concern carousel Redesign
    ...
    And common Concern carousel arrow colour should be "#0097A8" for MD site
    And the text underline colour should be "#0097A8" for MD site

  Scenario: Verify common concerns 4 column Redesign
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-2/magazine-and-common/"
    Then I should be able to see 4 Common Concern carousel component
    And the common concerns 4 column text underline colour should be "#0097A8" for MD site

  Scenario: Verify common concerns 3 column Redesign
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-2/magazine-and-common/"
    Then I should be able to see 3 Common Concern carousel component
    And the common concerns 3 text underline colour should be "#0097A8" for MD site
  ...
  Scenario: Verify Magazine Carousel Redesign
    ...
    And magazine carousel arrow colour should be "#0097A8" for MD site
    And the magazine carousel title colour should be "#0097A8" for MD site

  Scenario: Verify Magazine Carousel 4 column Redesign
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-2/magazine-and-common/"
    Then I should be able to see 4 Magazine carousel component
    And the 4 magazine carousel title colour should be "#0097A8" for MD site

  Scenario: Verify Magazine Carousel 2 column Redesign
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-2/magazine-and-common/"
    Then I should be able to see 2 Magazine carousel component
    And the 2 magazine carousel title colour should be "#0097A8" for MD site
  ...
  Scenario: Verify Fact Card
    ...
    Then the fact card should have a "#D6EDE8", "#ACD08C", "#07BCDA", "#F7F8FC" background
  ...
  Scenario: Verify component with tabs
    ...
    And Tab has background colour as 'rgb(240, 250, 252)' for MD site
  ...
  Scenario: Verify cost estimator cost colour for MD
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-2/cost-estimator/"
    Then the cost estimator cost colour should be "#0097a8" for MD site
    And the cost estimator arrow colour should be "#0097a8" for MD site
    And the cost estimator tab border top colour should be "#0097a8" for MD site

  # TEASER
  Scenario: Verify when user clicks "See More" link to view more description
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-4/teaser/teaser1/?sdfs"
    ...
    And verify the "see more" link has underline with color "#0097a8"
    ...
    And verify "see less" link has underline with color "#0097a8"
  ...
  Scenario: Verify image is present at left position and teaser with CTA
    ...
    And verify the CTA link has underline with color "#0097a8"
  ...
  Scenario: Verify image is present at right position and teaser with CTA
    ...
    And verify CTA link has underline with color "#0097a8"
  ...
  Scenario: Verify image is present and Teaser without CTA
    ...
    And title should be in the "Poppins, sans-serif" and font size should be "52px" on MD site
    And the description should be in "Poppins, sans-serif" and the font size should be "18px" on MD site
  ...
  Scenario: Verify 3 cards listing
    ...
    And "VIEW ALL" button should be displayed on right side on MD site
    And the Button text "VIEW ALL" is having font family "Poppins, sans-serif" and font size "18px" on 3 cards listing on MD site
    And I see that there are "3" cards in the listing on MD site
    And Each card has image, title and description on MD site
    And title should be in "#0097a8" color on MD site
    And the Card title is having font family "Poppins, sans-serif" and font size "24px" on 3 cards listing on MD site
    And the Card description is having font family 'Poppins, sans-serif' and font size "18px" on 3 cards listing on MD site
    And I see that each article title is a link to the full article and with a 200 status code on MD site
    And I see that the "VIEW ALL" button should have 200 status code on 3 cards listing on MD site

  Scenario: Verify 4 cards listing
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-3/dynamic-listing/"
    Then I see the 4 cards listing variation on MD site
    And "VIEW ALL" button should be displayed on the right side on MD site
    And the Button text "VIEW ALL" is having font family "Poppins, sans-serif" and font size "18px" on 4 cards listing component on MD site
    And I see that there are "4" cards on cards listing on MD site
    And Each card has image, title and description on 4 cards listing on MD site
    And title should be in "#0097a8" color on 4 cards listing on MD site
    And the Card title is having font family "Poppins, sans-serif" and font size "24px" on 4 cards listing on MD site
    And the Card description is having font family 'Poppins, sans-serif' and font size "18px" on 4 cards listing on MD site
    And Verify that each article title is a link to the full article and with a 200 status code on MD site
    And I see that the "VIEW ALL" button should have 200 status code on 4 cards listing on MD site

  Scenario: Verify carousel listing
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-3/dynamic-listing/"
    Then I should see carousel listing variation on MD site
    And "View all" button should be displayed on right side of carousel listing component on MD site
    And the Button text "View all" is having font family "Poppins, sans-serif" and font size "18px" on 3 card carousel listing on MD site
    And I see that there are 3 cards in the listing on MD site
    And Each card has image title and description on MD site
    And the Card title is having font family "Poppins, sans-serif" and font size "24px" on carousel listing on MD site
    And the Card description is having font family "Poppins, sans-serif" and font size "18px" on carousel listing on MD site
    And Verify that each card title is a link to the full article and with a 200 status code on MD site
    And I see that the "View all" button should have 200 status code on 3 carousel listing on MD site
    And there is "more" link at right side of carousel on MD site
    And "more" text should be in "#0097a8" color on MD site
    And arrow icon with more text color should be "#0097a8" on MD site
    And when I click on "more" link, then i should see three more cards are coming up on MD site
    And there is "less" link on left side of carousel on MD site
    And "less" text should be in this "#0097a8" color on MD site
    And arrow icon with less text color should be "#0097a8" on MD site
    And clicking on "less" we should see first three cards on MD site
    And clicking on "more" link for three times, more link disappears and only "less" link should be present on MD site

  Scenario: Verify Carousel with Fact Card Display and Navigation
    Given I am on the LO_MD homepage
    When I navigate to the "safe-house/other-testing/sprint-3/dynamic-listing/"
    And the carousel should have a title and description below it on MD site
    And the title is having font family "Poppins, sans-serif" and font size "36px" on fact card component on MD site
    And the description is having font family "Poppins, sans-serif" and font size "18px" on fact card component on MD site
    And the carousel contains three cards in a row on MD site
    And verify that each card title is link to the full article and with a 200 status code on MD site
    And each card should have an image, title in blue color and a description on MD site
    And the card title is having font family "Poppins, sans-serif" and font size "36px" on fact card component on MD site
    And the card description is having font family "Poppins, sans-serif" and font size "18px" on fact card component on MD site
    ...
    And the fact card title is having font family "Poppins, sans-serif" and font size "36px" on fact card component on MD site
    And the fact card description is having font family "Poppins, sans-serif" and font size "18px" on fact card component on MD site
    When I click on the next arrow on MD site
    Then the next set of three cards in the carousel should be displayed on MD site
    When I click on the previous arrow on MD site
    And the previous three cards in the carousel should be displayed on MD site
  ...
  Scenario: Verify Promoblock Component Styling
    ...
    And the primary button with "#ffcd47" background color and secondary with "#0097a8" border color should be visible
  ...
  Scenario: Verify Blog Home Variation
    ...
    And the title color should be "#0097a8"
  ...
  Scenario: Verify Featured Post Variation
    ...
    And the title color should be "#0097a8" on Featured Post
...
Scenario: Verify eBook download functionality
  ...
  And background color of popup should be "#D6EDE8"
...
Scenario: View Overview Information
  ...
  And I should see the following insurance information:
    ...
    | United Health Care |
    | UCCI               |
  And I should see phone number "623-476-5820" and fax number "fax : 623-476-5815"
  And color of phone number "623-476-5820" and fax number "fax : 623-476-5815" should be "#0097A8"
  ...
  And I should see address "20542 N Lake Pleasant Rd""Ste 115""Peoria, AZ""85382"
  And color of address "20542 N Lake Pleasant Rd""Ste 115""Peoria, AZ""85382" should be "#0097A8"
  ...
  Then verify that Book Appointment CTA button has "https://www.LakePleasant1stFamilyMedicine.com/contact/appt-only" in URL, response status is 200
  ...
  And there should be text below button as "We are located on N Lake Pleasant Rd & W Beardsley Rd, in the Sun Grove Professional Plaza"
...
Scenario: Verify Tab Underline Color for MD
  Given I am on the LO_MD homepage
  When I navigate to the "safe-house/other-testing/sprint-4/faq/"
  Then I should see the tab is underlined with color "#0097a8"
...
Scenario: Verify the alert bar, address bar, and header
  ...
  And there is a background colour present for the alert bar "#ACD08C"
  And clicking on the close icon in the alert bar closes the alert bar
  And address bar text contains "Pleasant"
...
Scenario Outline: Verify the header elements and navigation functionality
  ...
  And the "SCHEDULE TODAY" button contains "https://www.LakePleasant1stFamilyMedicine.com/contact/appt-only" in the URL
  And "PATIENT LOGIN" button contains "/content/md/us/en/patient-portal" in the URL
...
Scenario: Verify the staff intro component and its elements
  Given I am on the LO_MD homepage
  When I navigate to the "safe-house/other-testing/sprint-4/staff-intro/?ic=ewwdre"
...
Scenario Outline: Verify Footer Links Navigation and Styling
  ...
  Examples:
    ...
    | Privacy Policy               | #0097A8 | Poppins, sans-serif | 16px     |
    | Notice of privacy practices  | #0097A8 | Poppins, sans-serif | 16px     |
    | Terms of Use                 | #0097A8 | Poppins, sans-serif | 16px     |
    | Notice of Non-Discrimination | #0097A8 | Poppins, sans-serif | 16px     |
    | Sitemap                      | #0097A8 | Poppins, sans-serif | 16px     |

Scenario: Verify Copyright text
  Given I am on the LO_MD homepage
  When I navigate to the ""
  And verify that copy right section is present
  And verify that font type is "Poppins, sans-serif" and font size is "12px" for MD site