...
//   primaryBttntext = ".cmp-button--primary .cmp-button .cmp-button__text";
...
//   seeMoreTitle = ".half-width-show-more .cmp-teaser__title";
//   seeMoreDesc = ".half-width-show-more .cmp-teaser__description p";
...
//   leftimageBttn = ".half-width-cta.left_image .cmp-button";
//   rightimageComponent = ".aem-Grid--11 .half-width-cta:nth-child(1)";
//   rightimageVisible =
//     ".aem-Grid--11 .half-width-cta:nth-child(3) .cmp-teaser__image .cmp-image";
//   rightImageTeaserTitle =
//     ".aem-Grid--11 .half-width-cta:nth-child(1) .cmp-teaser__title";
//   rightImageTeaserDesc =
//     ".aem-Grid--11 .half-width-cta:nth-child(1) .cmp-teaser__description";
//   rightimageBttn = ".aem-Grid--11 .half-width-cta:nth-child(1) .cmp-button";
//   teaserwithoutCTA = ".aem-Grid--12 .half-width-cta:nth-child(8) .cmp-teaser";
//   teaserwithoutCTAImage =
//     ".aem-Grid--12 .half-width-cta:nth-child(8) .cmp-teaser .cmp-teaser__image";
//   teaserwithoutCTATitle =
//     ".aem-Grid--12 .half-width-cta:nth-child(8) .cmp-teaser .cmp-teaser__title";
//   teaserwithoutCTADesc =
//     ".aem-Grid--12 .half-width-cta:nth-child(8) .cmp-teaser .cmp-teaser__description";
//   teaserwithoutCTAVisible =
//     ".aem-Grid--12 .half-width-cta:nth-child(8) .cmp-teaser .cmp-button";
...
//   staggeredCardDesc = ".staggeredcard--with-cta .cmp-teaser__description p";
...
//   costEstimatorVisible = ".panelcontainer";
//   costEstimatorActiveTab = ".cmp-tabs__tab--active";
//   costCardEstimator = ".panelcontainer .cmp-list__card";
//   costCardEstimatorTitle =
//     ".panelcontainer .cmp-list__card .cmp-teaser__title p";
//   costCardEstimatorCost =
//     ".panelcontainer .cmp-list__card .cmp-teaser__description p";
//   costCardEstimatorSubtext =
//     ".panelcontainer .cmp-list__card .cmp-teaser__subtitle span";
//   costEstimatorRightArrow = ".arrow-icons#right";
//   costEstimatorLeftArrow = ".arrow-icons#left";
//   CostEstimatorTabsAuthored = ".cmp-tabs__tablist .cmp-tabs__tab";
...
//   threeCardList = ".threecolumn";
//   threeCardMainTitle = ".threecolumn .cmp-title__text";
...
//   factCardTitleComponent = ".dynamiclisting-wrapper .cmp-title__text";
//   factCardDescComponent = ".dynamiclisting-wrapper .cmp-text p";
...
//     cy.get(css).eq(index).find(".cmp-list__item-title").as("getLinks");
...
//   dentalservicesImages(dentalservicesImage, index) {
//     cy.get(dentalservicesImage).eq(index).should("be.visible");
//   }

//   dentalservicesDescription(dentalservicesDesc, index) {
//     cy.get(dentalservicesDesc).eq(index).should("be.visible");
//   }
...
//     cy.get(this.subTitlewhitecopy).eq(0).should("be.visible");
//   }
...
//     cy.get(this.leftImageTeaser).should("be.visible");
//   }
...
//     cy.get(this.rightimageVisible).should("be.visible");
//   }
...
//     cy.get(this.quoteComponent).should("be.visible");
//   }
...
//     cy.get(this.costEstimatorActiveTab).should(
//       "have.css",
//       "background-color",
//       backgroundColor
//     );
...
//     cy.get(this.costEstimatorRightArrow).wait(1000).click();
//   }
...
//     cy.get(this.costEstimatorLeftArrow).wait(1000).click();
//   }
...
//                       cy.get(this.videoPlayButton)
//                         .should("be.visible")
//                         .then(($button) => {
//                           if ($button && $button.length > 0) {
//                             cy.get(this.videoClickButton).click();
...
//   officeprofileScheduleandInsuranceList(dataTable, css1, css2) {
//     var actualItems = [];
//     var expectedItems = [];
...
//     cy.get("select option").contains(option1).should("be.visible");
//     cy.get("select option").contains(option2).should("be.visible");
//     cy.get("select option").contains(option3).should("be.visible");
//   }

//   blogListingSortDefaultOptions(string) {
//     cy.get("select option:selected").invoke("text").should("contain", string);
//   }
...
//   //Click on links
//   clickLink(css) {
//     cy.get(css).find(".cmp-list__item-title").as("footerlink");
