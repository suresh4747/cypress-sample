class LocalKD {
  ...
  fontColorTeal = ".text-blue";
  fontColorWhite = ".text-white";
  fontColorYellow = ".text-light-yellow";
...
searchURLCheck(text) {
  ...
  stripBorderColor() {
    ...
    ).should("have.css", "border-bottom-color", "rgb(255, 238, 132)");
  }
  ...
  addresscolorCheck(css, string1, string2, string3, color) {
    var rgbCode = hexToRgb(color);
    cy.get(css)
      .contains(string1)
      .should("be.visible")
