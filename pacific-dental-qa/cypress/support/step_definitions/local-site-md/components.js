...
// const { LocalMD } = require("../../page/local-site-md/components");

// const localmd = new LocalMD();
...
// var teaserwithoutCTA = ".half-width-cta:nth-child(9)";
// var teaserwithoutCTAImage = ".half-width-cta:nth-child(9) .cmp-teaser__image";
// var teaserwithoutCTATitle = ".half-width-cta:nth-child(9) .cmp-teaser__title";
// var teaserwithoutCTADesc =
//   ".half-width-cta:nth-child(9) .cmp-teaser__description";
// var teaserwithoutCTAVisible = ".half-width-cta:nth-child(9) .cmp-button";
...
// var PrimaryNavNames =
//   ".cmp-header .cmp-header__nav-links .navigation .cmp-navigation__item a";
...
// Given("I am on the LO_MD homepage", () => {
//   localmd.homepagewebsite();
// });

// When("I navigate to the {string}", (url) => {
//   localmd.webPageNavigation(url);
// });
...
//   (fontType, fontFamily) => {
//     localmd.HeroComponentTitleCSS(heroComponent, fontType, fontFamily);
//   }
// );
...
//   (fontFamily) => {
//     localmd.HeroComponentDescCSS(heroComponentDesc, fontFamily);
//   }
// );
...
//   (fontType, fontFamily) => {
//     localmd.HeroComponentTitleCSS(heroComponentHafWidth, fontType, fontFamily);
//   }
// );
...
//   (fontFamily) => {
//     localmd.HeroComponentDescCSS(heroComponentHafWidthDesc, fontFamily);
//   }
// );
...
//   (fontType, fontFamily) => {
//     localmd.HeroComponentTitleCSS(heroComponentSimple, fontType, fontFamily);
//   }
// );
...
//   localmd.componentVisible(searchOverlay);
// });

// And("the overlay should have a search field and button", () => {
//   localmd.componentVisible(searchOverlaySearchbar);
//   localmd.componentVisible(searchOverlaySearchicon);
// });

// And(
//   "the overlay should have a heading with font size {string} and font style {string}",
//   (fontSize, fontFamily) => {
//     localmd.SearchOverlayCSS(searchOverlayTitle, fontSize, fontFamily);
//   }
// );

// And("the overlay should have quick links", () => {
//   localmd.componentVisible(searchOverlayQuickLinks);
// });

// And(
//   "the border bottom of search overloy should have {string} color",
//   (color) => {
//     localmd.bttnBorderColor(color, searchOverlay);
//   }
// );

// And("I enter text {string} in the search field", (text) => {
//   localmd.searchOverlaySearchType(text);
// });

// And("I click on the search button", () => {
//   localmd.searchOverlaySearchClick();
// });

// Then(
//   "the user should navigate to a page where the URL contains {string}",
//   (text) => {
//     localmd.searchURLCheck(text);
//   }
// );
...
// Then(
//   "the clicked photo should be highlighted in {string} for MD site",
//   (color) => {
//     localmd.stripBorderColor(color);
//   }
// );

// And("the corresponding bigger image should have background color black", () => {
//   localmd.largeImageBorderColor();
// });

// And("color of arrow icon should be {string} for MD site", (color) => {
//   localmd.arrowIconColorGallery(color);
// });

// // SWATCH COLOR COMPONENT
// And("check the first color code should be {string} for MD site", (string) => {
//   localmd.SwatchColors(string, 0);
// });

// And("check the second color code should be {string} for MD site", (string) => {
//   localmd.SwatchColors(string, 1);
// });

// And("check the third color code should be {string} for MD site", (string) => {
//   localmd.SwatchColors(string, 2);
// });

// And("check the fourth color code should be {string} for MD site", (string) => {
//   localmd.SwatchColors(string, 3);
// });

// // BUTTON COMPONENT
// Then(
//   "the primary button background color should be {string} for MD site",
//   (string) => {
//     localmd.buttonBackgrndColor(string, primaryCTA);
//   }
// );

// And("the primary button font size should be {string} for MD site", (string) => {
//   localmd.buttontextSize(string, primaryCTAText);
// });

// And(
//   "the primary button font colour should be {string} for MD site",
//   (string) => {
//     localmd.buttontextColor(string, primaryCTAText);
//   }
// );

// Then("the link CTA font size should be {string} for MD site", (string) => {
//   localmd.buttontextSize(string, linkCTAText);
// });

// And("the link CTA font colour should be {string} for MD site", (string) => {
//   localmd.buttontextColor(string, linkCTAText);
// });

// And("underline colour should be {string} for MD site", (string) => {
//   localmd.bttnBorderColor(string, linkCTA);
// });

// Then(
//   "the category Tag background color should be {string} for MD site",
//   (string) => {
//     localmd.buttonBackgrndColor(string, categoryTagCTA);
//   }
// );

// And("the category Tag font size should be {string} for MD site", (string) => {
//   localmd.buttontextSize(string, categoryTagCTAText);
// });

// And("the category Tag font colour should be {string} for MD site", (string) => {
//   localmd.buttontextColor(string, categoryTagCTAText);
// });

// Then(
//   "the secondary CTA background color should be {string} for MD site",
//   (string) => {
//     localmd.secondaryBackgrndColor(string, secondaryCTA);
//   }
// );

// And("the secondary CTA font size should be {string} for MD site", (string) => {
//   localmd.buttontextSize(string, secondaryCTAText);
// });

// And(
//   "the secondary CTA font colour should be {string} for MD site",
//   (string) => {
//     localmd.buttontextColor(string, secondaryCTAText);
//   }
// );

// And(
//   "the secondary CTA outline colour should be {string} for MD site",
//   (string) => {
//     localmd.bttnBorderColor(string, secondaryCTA);
//   }
// );

// And(
//   "the underline white on state font size should be {string} for MD site",
//   (string) => {
//     localmd.buttontextSize(string, underlineWhiteCTAText);
//   }
// );

// And(
//   "the underline white on state font colour should be {string} for MD site",
//   (string) => {
//     localmd.buttontextColor(string, underlineWhiteCTAText);
//   }
// );

// And(
//   "underline white on state underline colour should be {string} for MD site",
//   (string) => {
//     localmd.bttnBorderColor(string, underlineWhiteCTA);
//   }
// );

// Then(
//   "the secondary white CTA background color should be {string} for MD site",
//   (string) => {
//     localmd.buttonBackgrndColor(string, secondaryWhiteCTA);
//   }
// );

// And(
//   "the secondary white CTA font size should be {string} for MD site",
//   (string) => {
//     localmd.buttontextSize(string, secondaryWhiteCTAText);
//   }
// );

// And(
//   "the secondary white CTA font colour should be {string} for MD site",
//   (string) => {
//     localmd.buttontextColor(string, secondaryWhiteCTAText);
//   }
// );
...
// Then(
//   "I should see the font colour options {string}, {string}, {string}, {string} for MD",
//   (color1, color2, color3, color4) => {
//     localmd.fontColorOptions(color1, color2, color3, color4);
//   }
// );

// And(
//   "I should see the body text font size and font type for MD as {string} and {string}",
//   (size, fontFamily) => {
//     localmd.paraTextCSS(size, fontFamily);
//   }
// );

// And(
//   "I should see the link text colour for MD as {string} and size as {string}",
//   (size, color) => {
//     localmd.linkTextCSS(color, size);
//   }
// );

// And(
//   "I should see the font type for H1 in MD as {string} and size as {string}",
//   (heading, size) => {
//     localmd.headingTextCSS(heading, size);
//   }
// );

// And(
//   "I should see the font type for H2 in MD as {string} and size as {string}",
//   (heading, size) => {
//     localmd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for H3 in MD as {string} and size as {string}",
//   (heading, size) => {
//     localmd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for H4 in MD as {string} and size as {string}",
//   (heading, size) => {
//     localmd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for H5 in MD as {string} and size as {string}",
//   (heading, size) => {
//     localmd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for H6 in MD as {string} and size as {string}",
//   (heading, size) => {
//     localmd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 1 in MD as {string} and size as {string}",
//   (title, size) => {
//     localmd.stlyeTextCSS(title, size);
//   }
// );

// And(
//   "I should see the font type for Style 2 in MD as {string} and size as {string}",
//   (title, size) => {
//     localmd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 3 in MD as {string} and size as {string}",
//   (title, size) => {
//     localmd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 4 in MD as {string} and size as {string}",
//   (title, size) => {
//     localmd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 5 in MD as {string} and size as {string}",
//   (title, size) => {
//     localmd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 6 in MD as {string} and size as {string}",
//   (title, size) => {
//     localmd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 7 in MD as {string} and size as {string}",
//   (title, size) => {
//     localmd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 8 in MD as {string} and size as {string}",
//   (title, size) => {
//     localmd.stlyeTextCSS(title, size);
//   }
// );
...
// Then(
//   "I should see the title heading colour option as {string}, {string}, {string}, {string} for MD title",
//   (color1, color2, color3, color4) => {
//     localmd.fontColorOptionsTitle(color1, color2, color3, color4);
//   }
// );

// And(
//   "I should see the title heading type for H1 in MD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localmd.titleTextCSS(heading, fontSize);
//   }
// );

// And(
//   "I should see the title heading type for H2 in MD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localmd.titleTextCSS(heading, fontSize, "style-2");
//   }
// );

// And(
//   "I should see the title heading type for H3 in MD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localmd.titleTextCSS(heading, fontSize, "style-3");
//   }
// );

// And(
//   "I should see the title heading type for H4 in MD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localmd.titleTextCSS(heading, fontSize, "style-4");
//   }
// );

// And(
//   "I should see the title heading type for H5 in MD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localmd.titleTextCSS(heading, fontSize, "style-5");
//   }
// );

// And(
//   "I should see the title heading type for H6 in MD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localmd.titleTextCSS(heading, fontSize, "style-6");
//   }
// );

// And(
//   "I should see the title heading type for {string} Style 1 in MD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localmd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );

// And(
//   "I should see the title heading type for {string} Style 2 in MD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localmd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 3 in MD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localmd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 4 in MD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localmd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 5 in MD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localmd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 6 in MD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localmd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 7 in MD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localmd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 8 in MD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localmd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
//   localmd.buttonBackgrndColor(color, infoComponentbttn);
// });
...
//   localmd.componentVisible(commonConcernCard);
// });

// And(
//   "common Concern carousel arrow colour should be {string} for MD site",
//   (color) => {
//     localmd.commonConcernArrowColor(color);
//   }
// );

// And("the text underline colour should be {string} for MD site", (color) => {
//   localmd.bttnBorderColor(color, commonConcernCardTitle);
// });

// Then("I should be able to see 4 Common Concern carousel component", () => {
//   localmd.componentVisible(commonConcern4Column);
// });

// And(
//   "the common concerns 4 column text underline colour should be {string} for MD site",
//   (color) => {
//     localmd.threefourcommonConcernUnderline(commonConcern4Title, color);
//   }
// );

// Then("I should be able to see 3 Common Concern carousel component", () => {
//   localmd.componentVisible(commonConcern3Column);
// });

// And(
//   "the common concerns 3 text underline colour should be {string} for MD site",
//   (color) => {
//     localmd.threefourcommonConcernUnderline(commonConcern3Title, color);
//   }
// );
...
//   localmd.componentVisible(magazineCarousel);
// });

// And(
//   "magazine carousel arrow colour should be {string} for MD site",
//   (color) => {
//     localmd.magazinCarouselnArrowColor(color);
//   }
// );

// And(
//   "the magazine carousel title colour should be {string} for MD site",
//   (color) => {
//     localmd.magazineTitleColor(magazineCarouselTiTle, color);
//   }
// );

// Then("I should be able to see 4 Magazine carousel component", () => {
//   localmd.componentVisible(magazineCarousel4ColumnTitle);
// });

// And(
//   "the 4 magazine carousel title colour should be {string} for MD site",
//   (color) => {
//     localmd.magazineTitleColor(magazineCarousel4ColumnTitle, color);
//   }
// );

// Then("I should be able to see 2 Magazine carousel component", () => {
//   localmd.componentVisible(magazineCarousel2ColumnTitle);
// });

// And(
//   "the 2 magazine carousel title colour should be {string} for MD site",
//   (color) => {
//     localmd.magazineTitleColor(magazineCarousel2ColumnTitle, color);
//   }
// );
...
//     cy.factCardBackground(factCardBG, 3, color4);
//   }
// );
...
//   localmd.componentVisible(textcardIcon);
// });

// And("card should have a Title and Description", () => {
//   localmd.textCardIcon();
// });
...
// And("Tab has background colour as {string} for MD site", (backgroundColor) => {
...
// Then(
//   "the cost estimator cost colour should be {string} for MD site",
//   (color) => {
//     localmd.costEstimatorPrice(color);
//   }
// );

// And(
//   "the cost estimator arrow colour should be {string} for MD site",
//   (color) => {
//     localmd.arrowIconColor(color);
//   }
// );

// And(
//   "the cost estimator tab border top colour should be {string} for MD site",
//   (color) => {
//     localmd.costEstimatorTabBorder(color);
//   }
// );
...
//   (seeMore, color) => {
//     localmd.seeLessMoreBttnUndercolor(seeMoreLessLinkUnderline, seeMore, color);
//   }
// );
...
//   (seeLess, color) => {
//     localmd.seeLessMoreBttnUndercolor(seeMoreLessLinkUnderline, seeLess, color);
//   }
// );
...
//   localmd.CTABttnUndercolor(leftimageBttn, color);
// });
...
//   localmd.CTABttnUndercolor(rightimageBttn, color);
// });

// And("verify teaser with half image without CTA on the page on MD site", () => {
//   cy.teaserWithoutCTA(teaserwithoutCTA);
// });

// And("verify teaser image is present on MD site", () => {
//   cy.teaserWithoutCTAImage(teaserwithoutCTAImage);
// });

// And("verify title is present on the page on MD site", () => {
//   cy.teaserWithoutCTATitle(teaserwithoutCTATitle);
// });

// And("verify description is present on MD site", () => {
//   cy.teaserWithoutCTADesc(teaserwithoutCTADesc);
// });

// And(
//   "title should be in the {string} and font size should be {string} on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the description should be in {string} and the font size should be {string} on MD site",
//   (fontFamily, fontSize) => {
//     cy.teaserWithoutCTADescCSS(teaserwithoutCTADesc, fontFamily, fontSize);
//   }
// );

// And("there is no CTA link at bottom on MD site", () => {
//   cy.teaserWithoutCTAvisible(teaserwithoutCTAVisible);
// });

// // DYNAMIC LISTING
// Then("I shoud see the 3 cards listing variation on MD site", () => {
//   cy.threeCardListingVisible(threeCardList);
// });

// And(
//   "{string} button should be displayed on right side on MD site",
//   (string) => {
...
// And(
//   "the Button text {string} is having font family {string} and font size {string} on 3 cards listing on MD site",
...
// And(
//   "I see that there are {string} cards in the listing on MD site",
//   (string) => {
//     cy.CardListSize(threeCardListing, string);
//   }
// );

// And("Each card has image, title and description on MD site", () => {
//   cy.CardListTitleImageDesc(threeCardTitle, threeCardDesc, threeCardImage);
// });

// And("title should be in {string} color on MD site", (color) => {
//   localmd.titleColorListing(threeCardTitle, color);
// });

// And(
//   "the Card title is having font family {string} and font size {string} on 3 cards listing on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the Card description is having font family {string} and font size {string} on 3 cards listing on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "I see that each article title is a link to the full article and with a 200 status code on MD site",
//   () => {
...
// And(
//   "I see that the {string} button should have 200 status code on 3 cards listing on MD site",
//   (string) => {
//     cy.BttnLinkNotEmpty(threeCardBttnViewAllLink, 2);
//   }
// );

// Then("I see the 4 cards listing variation on MD site", () => {
//   cy.fourCardListingVisible(fourCardList);
// });

// And(
//   "{string} button should be displayed on the right side on MD site",
//   (string) => {
...
// And(
//   "the Button text {string} is having font family {string} and font size {string} on 4 cards listing component on MD site",
//   (string, fontFamily, fontSize) => {
...
// And(
//   "I see that there are {string} cards on cards listing on MD site",
//   (string) => {
...
// And(
//   "Each card has image, title and description on 4 cards listing on MD site",
//   () => {
...
// And(
//   "title should be in {string} color on 4 cards listing on MD site",
//   (color) => {
//     localmd.titleColorListing(fourCardTitle, color);
//   }
// );

// And(
//   "the Card title is having font family {string} and font size {string} on 4 cards listing on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the Card description is having font family {string} and font size {string} on 4 cards listing on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "Verify that each article title is a link to the full article and with a 200 status code on MD site",
//   () => {
...
// And(
//   "I see that the {string} button should have 200 status code on 4 cards listing on MD site",
//   () => {
//     cy.BttnLinkNotEmpty(fourCardBttnViewAllLink);
//   }
// );

// Then("I should see carousel listing variation on MD site", () => {
//   cy.threecarouselListingVisbile(threeCarouselComponent);
// });

// And(
//   "{string} button should be displayed on right side of carousel listing component on MD site",
//   (string) => {
//     cy.CardBttnVisible(threeCarouselBttnViewAll, 1, string);
//   }
// );

// And(
//   "the Button text {string} is having font family {string} and font size {string} on 3 card carousel listing on MD site",
//   (string, fontFamily, fontSize) => {
//     cy.CardBttnCSS(threeCarouselBttnViewAll, 2, string, fontFamily, fontSize);
//   }
// );

// And("I see that there are 3 cards in the listing on MD site", () => {
...
// And(
//   "the Card title is having font family {string} and font size {string} on carousel listing on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the Card description is having font family {string} and font size {string} on carousel listing on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "Verify that each card title is a link to the full article and with a 200 status code on MD site",
//   () => {
...
// And(
//   "I see that the {string} button should have 200 status code on 3 carousel listing on MD site",
//   () => {
//     cy.BttnLinkNotEmpty(threeCarouselBttnViewAllLink, 2);
//   }
// );

// And("{string} text should be in {string} color on MD site", (more, color) => {
//   localmd.moreLessColorCode(threeCarouselMore, more, color);
// });

// And(
//   "arrow icon with more text color should be {string} on MD site",
//   (color) => {
//     localmd.morearrowIconColorDymanicListing(color);
//   }
// );

// And("there is {string} link at right side of carousel on MD site", (string) => {
//   cy.threeCarouselMoreLinkVisbile(threeCarouselMore, string);
// });

// And(
//   "when I click on {string} link, then i should see three more cards are coming up on MD site",
//   (string) => {
...
// And("there is {string} link on left side of carousel on MD site", (string) => {
//   cy.threeCarouselLessLinkVisbile(threeCarouselLess, string);
// });

// And(
//   "{string} text should be in this {string} color on MD site",
//   (less, color) => {
//     localmd.moreLessColorCode(threeCarouselLess, less, color);
//   }
// );

// And(
//   "arrow icon with less text color should be {string} on MD site",
//   (color) => {
//     localmd.lessarrowIconColorDymanicListing(color);
//   }
// );

// And(
//   "clicking on {string} we should see first three cards on MD site",
//   (string) => {
...
// And(
//   "clicking on {string} link for three times, more link disappears and only {string} link should be present on MD site",
//   (string1, string2) => {
...
// And(
//   "the carousel should have a title and description below it on MD site",
//   () => {
...
// And(
//   "the title is having font family {string} and font size {string} on fact card component on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the description is having font family {string} and font size {string} on fact card component on MD site",
//   (fontFamily, fontSize) => {
//     cy.CardListDescCSS(factCardDescComponent, fontFamily, fontSize);
//   }
// );

// And("the carousel contains three cards in a row on MD site", () => {
//   cy.factCardSize(
//     threeCarouselTitle1,
//     threeCarouselTitle2,
//     threeCarouselTitle3,
...
// And(
//   "verify that each card title is link to the full article and with a 200 status code on MD site",
//   () => {
...
// And(
//   "each card should have an image, title in blue color and a description on MD site",
//   () => {
...
// And(
//   "the card title is having font family {string} and font size {string} on fact card component on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the card description is having font family {string} and font size {string} on fact card component on MD site",
//   (fontFamily, fontSize) => {
//     cy.CardListDescCSS(CardTitleDesc, fontFamily, fontSize);
//   }
// );

// And("the second card is a fact card on MD site", () => {
//   cy.factCardSecondTile(factCardComponenttile);
// });

// And("the fact card is not clickable on MD site", () => {
//   cy.BttnNotClickable(factCardComponentListing);
// });

// And("the fact card has a title with the description on MD site", () => {
//   cy.factCardAuthorDescVisible(factCardDesc, factCardAuthor);
// });

// And(
//   "the fact card title is having font family {string} and font size {string} on fact card component on MD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the fact card description is having font family {string} and font size {string} on fact card component on MD site",
//   (fontFamily, fontSize) => {
//     cy.CardListDescCSS(factCardAuthor, fontFamily, fontSize);
//   }
// );

// When("I click on the next arrow on MD site", () => {
//   cy.factCardNextClick(threeCarouselMore);
// });

// Then(
//   "the next set of three cards in the carousel should be displayed on MD site",
//   () => {
//     cy.factCardClickVerification(threeCarouselTitle4, threeCarouselTitle3);
//   }
// );

// When("I click on the previous arrow on MD site", () => {
//   cy.factCardPreviousClick(threeCarouselLess);
// });

// And(
//   "the previous three cards in the carousel should be displayed on MD site",
//   () => {
//     cy.factCardSize(
//       threeCarouselTitle1,
//       threeCarouselTitle2,
...
//     localmd.buttonBackgrndColor(color1, newsLetterPrimary);
//     cy.ComponentsVisible(newsLetterSecondary);
//     localmd.bttnBorderColor(color2, newsLetterSecondary);
//   }
// );
...
//   localmd.titleColorListing(curatedTitle, color);
// });
...
//   localmd.titleColorListing(featuredTitle, color);
// });
...
//   localmd.ebookBachgrndColor(backgrndColor, color);
// });
...
//   localmd.componentVisible(FAQTabs);
// });
...
//   localmd.componentVisible(FAQTabsTitle);
// });

// And("there should be a description", () => {
//   localmd.componentVisible(FAQTabsDescription);
// });
...
//     localmd.phonecolorCheck(officeProviderPhNum, string1, string2, color);
//   }
// );
...
// When(
//   "the URL should contain the staff name and the response should be 200",
//   (string) => {
//     localmd.buttonResponseAndURLCheck(string);
//   }
// );
...
//   () => {
//     localmd.componentVisible(alertBar);
//     localmd.componentVisible(addressbar);
//     localmd.componentVisible(primaryNavBar);
//   }
// );

// And("the alert bar should have text and a close icon", () => {
//   localmd.componentVisible(alertbarText);
//   localmd.componentVisible(alertbarCloseIcon);
// });

// And(
//   "there is a background colour present for the alert bar {string}",
//   (color) => {
//     localmd.BackgrndColor(color, alertBar);
//   }
// );

// And("clicking on the close icon in the alert bar closes the alert bar", () => {
//   localmd.alertDisappear(alertbarCloseIcon, alertBar);
// });

// And("address bar text contains {string}", (text) => {
//   localmd.addressBarTexts(text);
// });

// And("the address bar contains a phone number", () => {
//   localmd.componentVisible(addressBarContactText);
// });
...
//   localmd.componentVisible(primaryNavBarLogo);
// });

// And("clicking on the logo icon navigates the user to the home page", () => {
//   localmd.smilegenLogoHeaderNav(primaryNavBarLogo);
// });

// And("the {string} button contains {string} in the URL", (bttn, Link) => {
//   localmd.primaryNavBttn(primaryNavBttn1, bttn, primaryNavBttnLink1, Link);
// });

// And("{string} button contains {string} in the URL", (bttn, Link) => {
//   localmd.primaryNavBttn(primaryNavBttn2, bttn, primaryNavBttnLink2, Link);
// });

// And("there is a search icon", () => {
//   localmd.componentVisible(primarySearchIcon);
// });

// And("the primary navigation items {string} are present", (NavNames) => {
//   localmd.componentsVisibleContains(PrimaryNavNames, NavNames);
// });

// And(
//   "Each navigation {string} has below URL-fragment {string} in URL",
//   (NavNames, URL) => {
//     localmd.primaryNavLinks(PrimaryNavNames, NavNames, URL);
//   }
// );

// // STAFF INTRO
// Then("I should be able to see the staff intro component", () => {
//   localmd.componentVisible(staffIntroVisible);
// });

// And("I should see the staff intro has a title, text, button, and image", () => {
//   localmd.componentVisible(staffIntroText);
//   localmd.componentVisible(staffIntroTitle);
//   localmd.componentVisible(staffIntroImage);
//   localmd.componentVisible(staffIntroBttn);
// });

// And(
//   "the title font type is {string} and font size is {string}",
//   (fontFamily, fontSize) => {
//     localmd.StaffIntroCSS(staffIntroTitle, fontFamily, fontSize);
//   }
// );
...
//   (fontFamily, fontSize) => {
//     localmd.StaffIntroCSS(staffIntroText, fontFamily, fontSize);
//   }
// );
...
//   localmd.footerNavigation();
// });

// And(
//   "all footer column headings should have color {string} for MD site",
//   (color) => {
//     localmd.footerColumnHeading(color);
//   }
// );
...
//     localmd.footerCopyrightLinksCSS(link, color, fontFamily, fontSize);
//   }
// );

// And("verify that copy right section is present", () => {
//   localmd.componentVisible(footerCopyrightText);
// });

// And(
//   "verify that font type is {string} and font size is {string} for MD site",
//   (fontFamily, fontSize) => {
//     localmd.footerCopyrightTextCSS(fontFamily, fontSize);
//   }
// );
