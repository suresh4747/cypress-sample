...
// const { LocalKD } = require("../../page/local-site-kd/components");

// const localkd = new LocalKD();
...
// var footerHeaderLinks =
//   ".cmp-footer__column:not(:first-child) .cmp-footer__list a";
...
//   localkd.homepagewebsite();
// });

// When("I navigate to the {string}", (url) => {
//   localkd.webPageNavigation(url);
// });
...
//   (fontType, fontFamily) => {
//     localkd.HeroComponentTitleCSS(heroComponent, fontType, fontFamily);
//   }
// );
...
//   (fontFamily) => {
//     localkd.HeroComponentDescCSS(heroComponentDesc, fontFamily);
//   }
// );
...
//   (fontType, fontFamily) => {
//     localkd.HeroComponentTitleCSS(heroComponentHafWidth, fontType, fontFamily);
//   }
// );
...
//   (fontFamily) => {
//     localkd.HeroComponentDescCSS(heroComponentHafWidthDesc, fontFamily);
//   }
// );
...
//   (fontType, fontFamily) => {
//     localkd.HeroComponentTitleCSS(heroComponentSimple, fontType, fontFamily);
//   }
// );
...
//   localkd.componentVisible(searchOverlay);
// });

// And("the overlay should have a search field and button", () => {
//   localkd.componentVisible(searchOverlaySearchbar);
//   localkd.componentVisible(searchOverlaySearchicon);
// });

// And(
//   "the overlay should have a heading with font size {string} and font style {string}",
//   (fontSize, fontFamily) => {
//     localkd.SearchOverlayCSS(searchOverlayTitle, fontSize, fontFamily);
//   }
// );

// And("the overlay should have quick links", () => {
//   localkd.componentVisible(searchOverlayQuickLinks);
// });

// And(
//   "the border bottom of search overloy should have {string} color",
//   (color) => {
//     localkd.bttnBorderColor(color, searchOverlay);
//   }
// );

// And("I enter text {string} in the search field", (text) => {
//   localkd.searchOverlaySearchType(text);
// });

// And("I click on the search button", () => {
//   localkd.searchOverlaySearchClick();
// });

// Then(
//   "the user should navigate to a page where the URL contains {string}",
//   (text) => {
//     localkd.searchURLCheck(text);
//   }
// );
...
// Then(
//   "the clicked photo should be highlighted in {string} for KD site",
//   (color) => {
//     localkd.stripBorderColor(color);
//   }
// );

// And("the corresponding bigger image should have background color black", () => {
//   localkd.largeImageBorderColor();
// });

// And("color of arrow icon should be {string} for KD site", (color) => {
//   localkd.arrowIconColorGallery(color);
// });

// // SWATCH COLOR COMPONENT
// And("check the first color code should be {string} for KD site", (string) => {
//   localkd.SwatchColors(string, 0);
// });

// And("check the second color code should be {string} for KD site", (string) => {
//   localkd.SwatchColors(string, 1);
// });

// And("check the third color code should be {string} for KD site", (string) => {
//   localkd.SwatchColors(string, 2);
// });

// And("check the fourth color code should be {string} for KD site", (string) => {
//   localkd.SwatchColors(string, 3);
// });

// // BUTTON COMPONENT
// Then(
//   "the primary button background color should be {string} for KD site",
//   (string) => {
//     localkd.buttonBackgrndColor(string, primaryCTA);
//   }
// );

// And("the primary button font size should be {string} for KD site", (string) => {
//   localkd.buttontextSize(string, primaryCTAText);
// });

// And(
//   "the primary button font colour should be {string} for KD site",
//   (string) => {
//     localkd.buttontextColor(string, primaryCTAText);
//   }
// );

// Then("the link CTA font size should be {string} for KD site", (string) => {
//   localkd.buttontextSize(string, linkCTAText);
// });

// And("the link CTA font colour should be {string} for KD site", (string) => {
//   localkd.buttontextColor(string, linkCTAText);
// });

// And("underline colour should be {string} for KD site", (string) => {
//   localkd.bttnBorderColor(string, linkCTA);
// });

// Then(
//   "the category Tag background color should be {string} for KD site",
//   (string) => {
//     localkd.buttonBackgrndColor(string, categoryTagCTA);
//   }
// );

// And("the category Tag font size should be {string} for KD site", (string) => {
//   localkd.buttontextSize(string, categoryTagCTAText);
// });

// And("the category Tag font colour should be {string} for KD site", (string) => {
//   localkd.buttontextColor(string, categoryTagCTAText);
// });

// Then(
//   "the secondary CTA background color should be {string} for KD site",
//   (string) => {
//     localkd.secondaryBackgrndColor(string, secondaryCTA);
//   }
// );

// And("the secondary CTA font size should be {string} for KD site", (string) => {
//   localkd.buttontextSize(string, secondaryCTAText);
// });

// And(
//   "the secondary CTA font colour should be {string} for KD site",
//   (string) => {
//     localkd.buttontextColor(string, secondaryCTAText);
//   }
// );

// And(
//   "the secondary CTA outline colour should be {string} for KD site",
//   (string) => {
//     localkd.bttnBorderColor(string, secondaryCTA);
//   }
// );

// And(
//   "the underline white on state font size should be {string} for KD site",
//   (string) => {
//     localkd.buttontextSize(string, underlineWhiteCTAText);
//   }
// );

// And(
//   "the underline white on state font colour should be {string} for KD site",
//   (string) => {
//     localkd.buttontextColor(string, underlineWhiteCTAText);
//   }
// );

// And(
//   "underline white on state underline colour should be {string} for KD site",
//   (string) => {
//     localkd.bttnBorderColor(string, underlineWhiteCTA);
//   }
// );

// Then(
//   "the secondary white CTA background color should be {string} for KD site",
//   (string) => {
//     localkd.buttonBackgrndColor(string, secondaryWhiteCTA);
//   }
// );

// And(
//   "the secondary white CTA font size should be {string} for KD site",
//   (string) => {
//     localkd.buttontextSize(string, secondaryWhiteCTAText);
//   }
// );

// And(
//   "the secondary white CTA font colour should be {string} for KD site",
//   (string) => {
//     localkd.buttontextColor(string, secondaryWhiteCTAText);
//   }
// );
...
// Then(
//   "I should see the font colour options {string}, {string}, {string}, {string} for KD",
//   (color1, color2, color3, color4) => {
//     localkd.fontColorOptions(color1, color2, color3, color4);
//   }
// );

// And(
//   "I should see the body text font size and font type for KD as {string} and {string}",
//   (size, fontFamily) => {
//     localkd.paraTextCSS(size, fontFamily);
//   }
// );

// And(
//   "I should see the link text colour for KD as {string} and size as {string}",
//   (size, color) => {
//     localkd.linkTextCSS(color, size);
//   }
// );

// And(
//   "I should see the font type for H1 in KD as {string} and size as {string}",
//   (heading, size) => {
//     localkd.headingTextCSS(heading, size);
//   }
// );

// And(
//   "I should see the font type for H2 in KD as {string} and size as {string}",
//   (heading, size) => {
//     localkd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for H3 in KD as {string} and size as {string}",
//   (heading, size) => {
//     localkd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for H4 in KD as {string} and size as {string}",
//   (heading, size) => {
//     localkd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for H5 in KD as {string} and size as {string}",
//   (heading, size) => {
//     localkd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for H6 in KD as {string} and size as {string}",
//   (heading, size) => {
//     localkd.headingTextCSS(heading, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 1 in KD as {string} and size as {string}",
//   (title, size) => {
//     localkd.stlyeTextCSS(title, size);
//   }
// );

// And(
//   "I should see the font type for Style 2 in KD as {string} and size as {string}",
//   (title, size) => {
//     localkd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 3 in KD as {string} and size as {string}",
//   (title, size) => {
//     localkd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 4 in KD as {string} and size as {string}",
//   (title, size) => {
//     localkd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 5 in KD as {string} and size as {string}",
//   (title, size) => {
//     localkd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 6 in KD as {string} and size as {string}",
//   (title, size) => {
//     localkd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 7 in KD as {string} and size as {string}",
//   (title, size) => {
//     localkd.stlyeTextCSS(title, size);
//   }
// );
...
// And(
//   "I should see the font type for Style 8 in KD as {string} and size as {string}",
//   (title, size) => {
//     localkd.stlyeTextCSS(title, size);
//   }
// );
...
// Then(
//   "I should see the title heading colour option as {string}, {string}, {string}, {string} for KD title",
//   (color1, color2, color3, color4) => {
//     localkd.fontColorOptionsTitle(color1, color2, color3, color4);
//   }
// );

// And(
//   "I should see the title heading type for H1 in KD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localkd.titleTextCSS(heading, fontSize);
//   }
// );

// And(
//   "I should see the title heading type for H2 in KD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localkd.titleTextCSS(heading, fontSize, "style-2");
//   }
// );

// And(
//   "I should see the title heading type for H3 in KD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localkd.titleTextCSS(heading, fontSize, "style-3");
//   }
// );

// And(
//   "I should see the title heading type for H4 in KD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localkd.titleTextCSS(heading, fontSize, "style-4");
//   }
// );

// And(
//   "I should see the title heading type for H5 in KD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localkd.titleTextCSS(heading, fontSize, "style-5");
//   }
// );

// And(
//   "I should see the title heading type for H6 in KD as {string} and heading size as {string}",
//   (heading, fontSize) => {
//     localkd.titleTextCSS(heading, fontSize, "style-6");
//   }
// );

// And(
//   "I should see the title heading type for {string} Style 1 in KD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localkd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );

// And(
//   "I should see the title heading type for {string} Style 2 in KD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localkd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 3 in KD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localkd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 4 in KD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localkd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 5 in KD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localkd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 6 in KD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localkd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 7 in KD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localkd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
// And(
//   "I should see the title heading type for {string} Style 8 in KD as {string} and heading size as {string}",
//   (heading, style, fontSize) => {
//     localkd.titlestlyeTextCSS(heading, style, fontSize);
//   }
// );
...
//   localkd.buttonBackgrndColor(color, infoComponentbttn);
// });
...
//   localkd.componentVisible(commonConcernCard);
// });

// And(
//   "common Concern carousel arrow colour should be {string} for KD site",
//   (color) => {
//     localkd.commonConcernArrowColor(color);
//   }
// );

// And("the text underline colour should be {string} for KD site", (color) => {
//   localkd.bttnBorderColor(color, commonConcernCardTitle);
// });

// Then("I should be able to see 4 Common Concern carousel component", () => {
//   localkd.componentVisible(commonConcern4Column);
// });

// And(
//   "the common concerns 4 column text underline colour should be {string} for KD site",
//   (color) => {
//     localkd.threefourcommonConcernUnderline(commonConcern4Title, color);
//   }
// );

// Then("I should be able to see 3 Common Concern carousel component", () => {
//   localkd.componentVisible(commonConcern3Column);
// });

// And(
//   "the common concerns 3 text underline colour should be {string} for KD site",
//   (color) => {
//     localkd.threefourcommonConcernUnderline(commonConcern3Title, color);
//   }
// );
...
//   localkd.componentVisible(magazineCarousel);
// });

// And(
//   "magazine carousel arrow colour should be {string} for KD site",
//   (color) => {
//     localkd.magazinCarouselnArrowColor(color);
//   }
// );

// And(
//   "the magazine carousel title colour should be {string} for KD site",
//   (color) => {
//     localkd.magazineTitleColor(magazineCarouselTiTle, color);
//   }
// );

// Then("I should be able to see 4 Magazine carousel component", () => {
//   localkd.componentVisible(magazineCarousel4ColumnTitle);
// });

// And(
//   "the 4 magazine carousel title colour should be {string} for KD site",
//   (color) => {
//     localkd.magazineTitleColor(magazineCarousel4ColumnTitle, color);
//   }
// );

// Then("I should be able to see 2 Magazine carousel component", () => {
//   localkd.componentVisible(magazineCarousel2ColumnTitle);
// });

// And(
//   "the 2 magazine carousel title colour should be {string} for KD site",
//   (color) => {
//     localkd.magazineTitleColor(magazineCarousel2ColumnTitle, color);
//   }
// );
...
//   localkd.componentVisible(textcardIcon);
// });

// And("card should have a Title and Description", () => {
//   localkd.textCardIcon();
// });
...
// And("Tab has background colour as {string} for KD site", (backgroundColor) => {
...
// Then(
//   "the cost estimator cost colour should be {string} for KD site",
//   (color) => {
//     localkd.costEstimatorPrice(color);
//   }
// );

// And(
//   "the cost estimator arrow colour should be {string} for KD site",
//   (color) => {
//     localkd.arrowIconColor(color);
//   }
// );

// And(
//   "the cost estimator tab border top colour should be {string} for KD site",
//   (color) => {
//     localkd.costEstimatorTabBorder(color);
//   }
// );
...
//   (seeMore, color) => {
//     localkd.seeLessMoreBttnUndercolor(seeMoreLessLinkUnderline, seeMore, color);
//   }
// );
...
//   (seeLess, color) => {
//     localkd.seeLessMoreBttnUndercolor(seeMoreLessLinkUnderline, seeLess, color);
//   }
// );
...
//   localkd.CTABttnUndercolor(leftimageBttn, color);
// });
...
//   localkd.CTABttnUndercolor(rightimageBttn, color);
// });
...
// And(
//   "title should be in the {string} and font size should be {string} on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the description should be in {string} and the font size should be {string} on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "{string} button should be displayed on right side on KD site",
//   (string) => {
...
// And(
//   "the Button text {string} is having font family {string} and font size {string} on 3 cards listing on KD site",
...
// And(
//   "I see that there are {string} cards in the listing on KD site",
//   (string) => {
...
// And("title should be in {string} color on KD site", (color) => {
//   localkd.titleColorListing(threeCardTitle, color);
// });

// And(
//   "the Card title is having font family {string} and font size {string} on 3 cards listing on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the Card description is having font family {string} and font size {string} on 3 cards listing on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "I see that each article title is a link to the full article and with a 200 status code on KD site",
//   () => {
...
// And(
//   "I see that the {string} button should have 200 status code on 3 cards listing on KD site",
//   (string) => {
...
// And(
//   "{string} button should be displayed on the right side on KD site",
//   (string) => {
...
// And(
//   "the Button text {string} is having font family {string} and font size {string} on 4 cards listing component on KD site",
//   (string, fontFamily, fontSize) => {
...
// And(
//   "I see that there are {string} cards on cards listing on KD site",
//   (string) => {
...
// And(
//   "Each card has image, title and description on 4 cards listing on KD site",
//   () => {
...
// And(
//   "title should be in {string} color on 4 cards listing on KD site",
//   (color) => {
//     localkd.titleColorListing(fourCardTitle, color);
//   }
// );

// And(
//   "the Card title is having font family {string} and font size {string} on 4 cards listing on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the Card description is having font family {string} and font size {string} on 4 cards listing on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "Verify that each article title is a link to the full article and with a 200 status code on KD site",
//   () => {
...
// And(
//   "I see that the {string} button should have 200 status code on 4 cards listing on KD site",
//   () => {
...
// And(
//   "{string} button should be displayed on right side of carousel listing component on KD site",
//   (string) => {
...
// And(
//   "the Button text {string} is having font family {string} and font size {string} on 3 card carousel listing on KD site",
//   (string, fontFamily, fontSize) => {
...
// And(
//   "the Card title is having font family {string} and font size {string} on carousel listing on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the Card description is having font family {string} and font size {string} on carousel listing on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "Verify that each card title is a link to the full article and with a 200 status code on KD site",
//   () => {
...
// And(
//   "I see that the {string} button should have 200 status code on 3 carousel listing on KD site",
//   () => {
//     cy.BttnLinkNotEmpty(threeCarouselBttnViewAllLink, 2);
//   }
// );

// And("{string} text should be in {string} color on KD site", (more, color) => {
//   localkd.moreLessColorCode(threeCarouselMore, more, color);
// });

// And(
//   "arrow icon with more text color should be {string} on KD site",
//   (color) => {
//     localkd.morearrowIconColorDymanicListing(color);
//   }
// );

// And("there is {string} link at right side of carousel on KD site", (string) => {
//   cy.threeCarouselMoreLinkVisbile(threeCarouselMore, string);
// });

// And(
//   "when I click on {string} link, then i should see three more cards are coming up on KD site",
//   (string) => {
...
// And("there is {string} link on left side of carousel on KD site", (string) => {
//   cy.threeCarouselLessLinkVisbile(threeCarouselLess, string);
// });

// And(
//   "{string} text should be in this {string} color on KD site",
//   (less, color) => {
//     localkd.moreLessColorCode(threeCarouselLess, less, color);
//   }
// );

// And(
//   "arrow icon with less text color should be {string} on KD site",
//   (color) => {
//     localkd.lessarrowIconColorDymanicListing(color);
//   }
// );

// And(
//   "clicking on {string} we should see first three cards on KD site",
//   (string) => {
...
// And(
//   "clicking on {string} link for three times, more link disappears and only {string} link should be present on KD site",
//   (string1, string2) => {
...
// And(
//   "the carousel should have a title and description below it on KD site",
//   () => {
...
// And(
//   "the title is having font family {string} and font size {string} on fact card component on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the description is having font family {string} and font size {string} on fact card component on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "verify that each card title is link to the full article and with a 200 status code on KD site",
//   () => {
...
// And(
//   "each card should have an image, title in blue color and a description on KD site",
//   () => {
...
// And(
//   "the card title is having font family {string} and font size {string} on fact card component on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the card description is having font family {string} and font size {string} on fact card component on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the fact card title is having font family {string} and font size {string} on fact card component on KD site",
//   (fontFamily, fontSize) => {
...
// And(
//   "the fact card description is having font family {string} and font size {string} on fact card component on KD site",
//   (fontFamily, fontSize) => {
...
// Then(
//   "the next set of three cards in the carousel should be displayed on KD site",
//   () => {
...
// And(
//   "the previous three cards in the carousel should be displayed on KD site",
//   () => {
//     cy.factCardSize(
//       threeCarouselTitle1,
//       threeCarouselTitle2,
...
//     localkd.buttonBackgrndColor(color1, newsLetterPrimary);
//     cy.ComponentsVisible(newsLetterSecondary);
//     localkd.bttnBorderColor(color2, newsLetterSecondary);
//   }
// );
...
//   localkd.titleColorListing(curatedTitle, color);
// });
...
//   localkd.titleColorListing(featuredTitle, color);
// });
...
//   localkd.ebookBachgrndColor(backgrndColor, color);
// });
...
//   localkd.componentVisible(FAQTabs);
// });
...
//   localkd.componentVisible(FAQTabsTitle);
// });

// And("there should be a description", () => {
//   localkd.componentVisible(FAQTabsDescription);
// });
...
//     localkd.phonecolorCheck(officeProviderPhNum, string1, string2, color);
//   }
// );
...
// And(
//   "color of address {string}{string}{string} should be {string}",
//   (string1, string2, string3, color) => {
//     localkd.addresscolorCheck(
//       officeProviderAddress,
//       string1,
//       string2,
//       string3,
...
//   (string) => {
//     localkd.buttonResponseAndURLCheck(string);
//   }
// );
...
//   () => {
//     localkd.componentVisible(alertBar);
//     localkd.componentVisible(addressbar);
//     localkd.componentVisible(primaryNavBar);
//   }
// );

// And("the alert bar should have text and a close icon", () => {
//   localkd.componentVisible(alertbarText);
//   localkd.componentVisible(alertbarCloseIcon);
// });

// And(
//   "there is a background colour present for the alert bar {string}",
//   (color) => {
//     localkd.BackgrndColor(color, alertBar);
//   }
// );

// And("clicking on the close icon in the alert bar closes the alert bar", () => {
//   localkd.alertDisappear(alertbarCloseIcon, alertBar);
// });

// And("address bar text contains {string}", (text) => {
//   localkd.addressBarTexts(text);
// });

// And("the address bar contains a phone number", () => {
//   localkd.componentVisible(addressBarContactText);
// });
...
//   localkd.componentVisible(primaryNavBarLogo);
// });

// And("clicking on the logo icon navigates the user to the home page", () => {
//   localkd.smilegenLogoHeaderNav(primaryNavBarLogo);
// });

// And("the {string} button contains {string} in the URL", (bttn, Link) => {
//   localkd.primaryNavBttn(primaryNavBttn1, bttn, primaryNavBttnLink1, Link);
// });

// And("{string} button contains {string} in the URL", (bttn, Link) => {
//   localkd.primaryNavBttn(primaryNavBttn2, bttn, primaryNavBttnLink2, Link);
// });

// And("there is a search icon", () => {
//   localkd.componentVisible(primarySearchIcon);
// });

// And("the primary navigation items {string} are present", (NavNames) => {
//   localkd.componentsVisibleContains(PrimaryNavNames, NavNames);
// });

// And(
//   "Each navigation {string} has below URL-fragment {string} in URL",
//   (NavNames, URL) => {
//     localkd.primaryNavLinks(PrimaryNavNames, NavNames, URL);
//   }
// );

// // STAFF INTRO
// Then("I should be able to see the staff intro component", () => {
//   localkd.componentVisible(staffIntroVisible);
// });

// And("I should see the staff intro has a title, text, button, and image", () => {
//   localkd.componentVisible(staffIntroText);
//   localkd.componentVisible(staffIntroTitle);
//   localkd.componentVisible(staffIntroImage);
//   localkd.componentVisible(staffIntroBttn);
// });

// And(
//   "the title font type is {string} and font size is {string}",
//   (fontFamily, fontSize) => {
//     localkd.StaffIntroCSS(staffIntroTitle, fontFamily, fontSize);
//   }
// );
...
//   (fontFamily, fontSize) => {
//     localkd.StaffIntroCSS(staffIntroText, fontFamily, fontSize);
//   }
// );
...
//   localkd.footerNavigation();
// });

// And(
//   "all footer column headings should have color {string} for KD site",
//   (color) => {
//     localkd.footerColumnHeading(color);
//   }
// );
...
//     localkd.footerCopyrightLinksCSS(link, color, fontFamily, fontSize);
//   }
// );

// And("verify that copy right section is present", () => {
//   localkd.componentVisible(footerCopyrightText);
// });

// And(
//   "verify that font type is {string} and font size is {string} for KD site",
//   (fontFamily, fontSize) => {
//     localkd.footerCopyrightTextCSS(fontFamily, fontSize);
//   }
// );
